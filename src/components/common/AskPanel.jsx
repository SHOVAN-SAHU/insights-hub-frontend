      ...
      <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
        ...
        <div style={{
          ...
          {typeof item.answer === 'string'
            ? item.answer
            : item.answer?.answer || item.answer?.text || JSON.stringify(item.answer)}
...
export default function AskPanel({ spaceId }) {
  ...
  const { answers, loading, error } = useSelector((s) => s.ask)
  ...
  const handleAsk = async () => {
    ...
    if (askQuestion.rejected.match(result)) {
      showToast(result.payload || 'Failed to get answer', 'error')
    }
  }
      ...
      <div style={{
        ...
        {answers.length === 0 && !loading ? (
          <div style={{
            ...
            <p style={{ fontSize: 13 }}>
              AI will search through all documents in this space to find answers.
            </p>
          </div>
        ) : (
        ...
        {loading && (
          <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
            ...
            <div style={{
              ...
              display: 'flex', alignItems: 'center', gap: 8, color: 'var(--text-secondary)', fontSize: 14,
            }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 10 }}>
          ...
          <Button
            ...
            style={{ alignSelf: 'flex-end', minWidth: 64, height: 42 }}
          >
            Send
          </Button>
        </div>
